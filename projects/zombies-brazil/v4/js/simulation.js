...
//========== Aqui são definidas as operações das equações de reação ==========
...
//========== Aqui são definidas as variáveis ==========
...
Simulation.prototype = {
    ...
    //========== Aqui, nessa parte inicial, ele define as probabilidades de que ocorra cada uma das reações ==========
    update_bond: function (bond) {
        ...
        if (bond.type == Z2R){
            ...
            weight = (bond.s0 == bond.s1) ? 1 : this.mu * this.alpha * this.sites[bond.s0].Z * this.sites[bond.s1].S + this.gamma * this.sites[bond.s0].Z;
        }
